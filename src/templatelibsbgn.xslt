...
<!--PATTERN pd10103-->
	...
	<!--RULE -->
<axsl:template match="sbgn:glyph[@class='source and sink' or @class='empty set']" priority="1000" mode="M10"><svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="sbgn:glyph[@class='source and sink' or @class='empty set']"/><axsl:variable name="id" select="@id"/><axsl:variable name="count" select="count(//sbgn:arc[(./@class = 'consumption') and (./@source = $id)])"/>

		<!--ASSERT error-->
<axsl:choose><axsl:when test="$count &lt;= 1"/><axsl:otherwise><svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="$count &lt;= 1"><axsl:attribute name="id">pd10103</axsl:attribute><axsl:attribute name="role">error</axsl:attribute><axsl:attribute name="location"><axsl:apply-templates select="." mode="schematron-select-full-path"/></axsl:attribute><svrl:text>The 'source and sink'/'empty set' glyph can be connected to at most one consumption glyph 
			</svrl:text> <svrl:diagnostic-reference diagnostic="id">
...
<!--PATTERN pd10107-->
	...
	<!--RULE -->
<axsl:template match="sbgn:glyph[@class='source and sink' or @class='empty set']" priority="1000" mode="M14"><svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="sbgn:glyph[@class='source and sink' or @class='empty set']"/><axsl:variable name="id" select="@id"/><axsl:variable name="count" select="count(//sbgn:arc[(./@class = 'production') and (./@target = $id)])"/>

		<!--ASSERT error-->
<axsl:choose><axsl:when test="$count &lt;= 1"/><axsl:otherwise><svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="$count &lt;= 1"><axsl:attribute name="id">pd10107</axsl:attribute><axsl:attribute name="role">error</axsl:attribute><axsl:attribute name="location"><axsl:apply-templates select="." mode="schematron-select-full-path"/></axsl:attribute><svrl:text>The 'source and sink'/'empty set' glyph can be connected to at most one production glyph 
			</svrl:text> <svrl:diagnostic-reference diagnostic="id">
<axsl:text/><axsl:value-of select="$id"/><axsl:text/></svrl:diagnostic-reference> <svrl:diagnostic-reference diagnostic="count">
...
<!--PATTERN pd10112-->
	...
	<!--RULE -->
<axsl:template match="sbgn:map/sbgn:glyph[(@class = 'unspecified entity' or      @class = 'simple chemical' or      @class = 'macromolecule' or      @class = 'nucleic acid feature' or     @class = 'simple chemical multimer' or      @class = 'macromolecule multimer' or      @class = 'nucleic acid feature multimer' or      @class = 'complex' or      @class = 'complex multimer' or      @class = 'source and sink' or      @class = 'empty set' or     @class = 'perturbing agent')]" priority="1000" mode="M19"><svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="sbgn:map/sbgn:glyph[(@class = 'unspecified entity' or      @class = 'simple chemical' or      @class = 'macromolecule' or      @class = 'nucleic acid feature' or     @class = 'simple chemical multimer' or      @class = 'macromolecule multimer' or      @class = 'nucleic acid feature multimer' or      @class = 'complex' or      @class = 'complex multimer' or      @class = 'source and sink' or      @class = 'empty set' or     @class = 'perturbing agent')]"/><axsl:variable name="id" select="@id"/><axsl:variable name="compartment-count" select="count(//sbgn:glyph[@class='compartment'])"/>
...
<axsl:template match="sbgn:arc[@class='equivalence arc']" priority="1000" mode="M23"><svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="sbgn:arc[@class='equivalence arc']"/><axsl:variable name="id" select="@id"/><axsl:variable name="source" select="@source"/><axsl:variable name="class" select="//sbgn:glyph[@id=$source]/@class"/>
		...
		<!--ASSERT error-->
<axsl:choose><axsl:when test="     $class='unspecified entity' or      $class='simple chemical' or     $class='macromolecule' or      $class='macromolecule multimer' or     $class='nucleic acid feature' or      $class='simple chemical multimer' or      $class='nucleic acid feature multimer' or      $class='complex' or      $class='complex multimer' or          $class='source and sink' or          $class='empty set' or      $class='perturbing agent'"/><axsl:otherwise><svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="$class='unspecified entity' or $class='simple chemical' or $class='macromolecule' or $class='macromolecule multimer' or $class='nucleic acid feature' or $class='simple chemical multimer' or $class='nucleic acid feature multimer' or $class='complex' or $class='complex multimer' or $class='source and sink' or $class='empty set' or $class='perturbing agent'"><axsl:attribute name="id">pd10127</axsl:attribute><axsl:attribute name="role">error</axsl:attribute><axsl:attribute name="location"><axsl:apply-templates select="." mode="schematron-select-full-path"/></axsl:attribute><svrl:text>Arc with class equivalence arc must have source reference to glyph of EPN classes
			</svrl:text> <svrl:diagnostic-reference diagnostic="id">
<axsl:text/><axsl:value-of select="$id"/><axsl:text/></svrl:diagnostic-reference> <svrl:diagnostic-reference diagnostic="source">
<axsl:text/><axsl:value-of select="$source"/><axsl:text/></svrl:diagnostic-reference> <svrl:diagnostic-reference diagnostic="class">
...
<!--PATTERN pd10131-->
	...
	<!--RULE -->
<axsl:template match="/sbgn:sbgn/sbgn:map/sbgn:glyph[     @class = 'unspecified entity' or      @class = 'simple chemical' or      @class = 'macromolecule' or      @class = 'nucleic acid feature' or     @class = 'simple chemical multimer' or      @class = 'macromolecule multimer' or      @class = 'nucleic acid feature multimer' or      @class = 'complex' or      @class = 'complex multimer' or      @class = 'source and sink' or      @class = 'empty set' or     @class = 'perturbing agent']    " priority="1000" mode="M27"><svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="/sbgn:sbgn/sbgn:map/sbgn:glyph[     @class = 'unspecified entity' or      @class = 'simple chemical' or      @class = 'macromolecule' or      @class = 'nucleic acid feature' or     @class = 'simple chemical multimer' or      @class = 'macromolecule multimer' or      @class = 'nucleic acid feature multimer' or      @class = 'complex' or      @class = 'complex multimer' or      @class = 'source and sink' or      @class = 'empty set' or     @class = 'perturbing agent']    "/><axsl:variable name="id" select="@id"/><axsl:variable name="class" select="//sbgn:arc[@source = $id or @target = $id]/@class"/>
